...
class NeracaAwalRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'uraian_kas.max' => 'Uraian kas tidak boleh lebih dari 255 karakter.',

            // Piutang
            'piutang.required' => 'Data piutang wajib diisi minimal satu.',
            'piutang.array' => 'Format piutang tidak valid.',
            'piutang.*.nama.required' => 'Nama debitur pada piutang wajib diisi.',
            ...
            'piutang.*.jatuh_tempo_piutang.required' => 'Tanggal jatuh tempo piutang wajib diisi.',
            'piutang.*.jatuh_tempo_piutang.date' => 'Format tanggal jatuh tempo piutang tidak valid.',

            // Hutang
            'hutang.required' => 'Data hutang wajib diisi minimal satu.',
            'hutang.array' => 'Format hutang tidak valid.',
            'hutang.*.nama.required' => 'Nama kreditur pada hutang wajib diisi.',
            ...
            'hutang.*.jatuh_tempo_hutang.required' => 'Tanggal jatuh tempo hutang wajib diisi.',
            'hutang.*.jatuh_tempo_hutang.date' => 'Format tanggal jatuh tempo hutang tidak valid.',

            // Barang (Persediaan Barang Dagangan)
            'barang_ids.required' => 'Minimal satu barang dagangan harus dipilih.',
            'barang_ids.array' => 'Format data barang tidak valid.',
            'barang_ids.*.exists' => 'Barang yang dipilih tidak ditemukan dalam daftar.',

            // Persediaan
            'total_persediaan.required' => 'Nilai total persediaan wajib diisi.',
            'total_persediaan.numeric' => 'Total persediaan harus berupa angka.',

            // Aset Tetap
            'tanah_bangunan.required' => 'Nilai tanah dan bangunan wajib diisi.',
            'kendaraan.required' => 'Nilai kendaraan wajib diisi.',
            'meubel_peralatan.required' => 'Nilai meubel & peralatan wajib diisi.',
        ];
    }
}
