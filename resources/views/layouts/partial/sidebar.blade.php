        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item has-sub {{ Request::is('keuangan/*') ? 'active' : '' }}">
                        <a href="#" class="sidebar-link">
                        ...
                        <ul class="submenu">
                            <li class="submenu-item">
                                <a href="{{ route('aset-hutang.index') }}" class="submenu-link">Aset Hutang</a>
                            </li>
                            ...
                            <li class="submenu-item">
                                <a href="{{route('keuangan.pengeluaran.rugi-laba')}}" class="submenu-link">Rugi Laba</a>
                            </li>
                    ...
                    <li class="sidebar-item has-sub {{ Request::is('barang/*') ? 'active' : '' }}">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="submenu-item">
                                <a href="{{ route('kartu-gudang.index') }}" class="submenu-link">Atur Kartu
                                    Gudang</a>
                            </li>
                        </ul>
                    </li>
