...
@section('section-heading', 'Dashboard Analytics')
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <p class="card-text">Rp {{ number_format($totalKas, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    ...
                    <p class="card-text">Rp {{ number_format($totalPiutang, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-danger text-white">
                <div class="card-body">
                    ...
                    <p class="card-text">Rp {{ number_format($totalHutang, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <h5 class="card-title">Total Persediaan</h5>
                    <p class="card-text">Rp {{ number_format($totalPersediaan, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    ...
                    <p class="card-text">Rp {{ number_format($labaBersih, 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
