...
@section('page-title',
    'Edit Data Agenda Rapat - ' .
    $rapat->judul_rapat .
    ' | Digitrans - Pengelolaan Administrasi dan
    Transaksi Bisnis')
...
@section('section-row')
    <div class="container mt-4">
        ...
        @endif
        <form action="{{ route('administrasi.rapat.update', ['rapatId' => $rapat->id]) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="nomor_surat_rapat"
                                    ...
                                    is-invalid
                                @enderror"
                                    value="{{ old('nomor_surat_rapat', $rapat->nomor_surat) }}" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="judul_rapat"
                                    value="{{ old('judul_rapat', $rapat->judul_rapat) }}" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Tempat</td>
                            <td>
                                <input type="text" name="tempat" value="{{ old('tempat', $rapat->tempat) }}"
                                    class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="nama_kota"
                                    ...
                                    value="{{ old('nama_kota', $rapat->nama_kota) }}" required>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Tanggal</td>
                            <td>
                                <input type="date" name="tanggal" value="{{ old('tanggal', $rapat->tanggal) }}"
                                    class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Waktu</td>
                            <td>
                                <input type="time" name="waktu" value="{{ old('waktu', $rapat->waktu) }}"
                                    class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pemimpin_rapat"
                                    value="{{ old('pemimpin_rapat', $rapat->pemimpin_rapat) }}" class="form-control">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="nama_notulis"
                                    value="{{ old('nama_notulis', $rapat->nama_notulis) }}" class="form-control">
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody id="peserta-rapat-body">
                            @foreach ($rapat->pesertaRapat as $i => $peserta)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td><input type="text" name="peserta_nama[]" value="{{ $peserta->nama }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="peserta_jabatan[]" value="{{ $peserta->jabatan }}"
                                            class="form-control"></td>
                                    <td>
                                        @if ($peserta->tanda_tangan)
                                            <img src="{{ asset('storage/' . $peserta->tanda_tangan) }}" width="60"
                                                class="mb-1">
                                        @endif
                                        <input type="file" name="peserta_ttd[]" class="form-control">
                                        <input type="hidden" name="peserta_ttd_old[]"
                                            value="{{ $peserta->tanda_tangan }}">
                                    </td>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody id="pembahasan-body">
                            @foreach ($rapat->rapatDetails as $detail)
                                <tr>
                                    <td><input type="text" name="pembahasan_agenda[]" class="form-control"
                                            value="{{ $detail->judul_agenda }}"></td>
                                    <td><input type="text" name="pembahasan_pembicara[]" class="form-control"
                                            value="{{ $detail->pembicara }}"></td>
                                    <td>
                                        <textarea name="pembahasan_isi[]" rows="2" class="form-control">{{ $detail->pembahasan }}</textarea>
                                    </td>
                                    <td><button type="button" class="btn btn-danger btn-sm deleteRow">X</button></td>
                                </tr>
                            @endforeach
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody id="tindak-lanjut-body">
                            @foreach ($rapat->tindakLanjutRapat as $i => $tindak)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td><input type="text" name="tindak_tindakan[]" value="{{ $tindak->tindakan }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="tindak_pelaksana[]" value="{{ $tindak->pelaksana }}"
                                            class="form-control"></td>
                                    <td><input type="date" name="tindak_target[]"
                                            value="{{ $tindak->target_selesai }}" class="form-control"></td>
                                    <td><input type="text" name="tindak_status[]" value="{{ $tindak->status }}"
                                            class="form-control"></td>
                                    <td><button type="button" class="btn btn-danger btn-sm deleteRow">X</button></td>
                                </tr>
                            @endforeach
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tr>
                            <td><input type="text" name="agenda_rapat_berikutnya" class="form-control"
                                    value="{{ $rapat->agenda_rapat_berikutnya }}"></td>
                            <td><input type="date" name="tanggal_rapat_berikutnya" class="form-control"
                                    value="{{ $rapat->tanggal_rapat_berikutnya }}"></td>
                            <td><input type="time" name="waktu_rapat_berikutnya" class="form-control"
                                    value="{{ $rapat->waktu_rapat_berikutnya }}"></td>
                        </tr>
                    </table>
