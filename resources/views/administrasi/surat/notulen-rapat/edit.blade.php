...
@section('section-row')
    <div class="container mt-4">
        ...
        {{-- ================= FORM ================= --}}
        <form id="formRapat" action="{{ route('administrasi.rapat.update', ['rapatId' => $rapat->id]) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="text" name="judul_rapat"
                                    value="{{ old('judul_rapat', $rapat->judul_rapat) }}" class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Tempat</td>
                            <td><input type="text" name="tempat" value="{{ old('tempat', $rapat->tempat) }}"
                                    class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Tanggal</td>
                            <td><input type="date" name="tanggal" value="{{ old('tanggal', $rapat->tanggal) }}"
                                    class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Waktu</td>
                            <td><input type="time" name="waktu" value="{{ old('waktu', $rapat->waktu) }}"
                                    class="form-control"></td>
                        </tr>
                        <tr>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody id="peserta-rapat-body">
                            @foreach ($rapat->pesertaRapat as $i => $p)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td><input type="text" name="peserta_nama[]" value="{{ $p->nama }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="peserta_jabatan[]" value="{{ $p->jabatan }}"
                                            class="form-control"></td>
                                    <td>
                                        @if ($p->tanda_tangan)
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm mb-3" id="addPeserta">+ Tambah
                        Peserta</button>
                    ...
                    <table class="table table-bordered">
                        <tbody id="pembahasan-body">
                            @foreach ($rapat->rapatDetails as $d)
                                <tr>
                                    <td><input type="text" name="pembahasan_agenda[]" value="{{ $d->judul_agenda }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="pembahasan_pembicara[]" value="{{ $d->pembicara }}"
                                            class="form-control"></td>
                                    <td>
                                        <textarea name="pembahasan_isi[]" class="form-control">{{ $d->pembahasan }}</textarea>
                                    </td>
                                    <td><button type="button" class="btn btn-danger btn-sm deleteRow">X</button></td>
                                </tr>
                            @endforeach
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm mb-3" id="addPembahasan">+ Tambah
                        Pembahasan</button>
                    ...
                    <table class="table table-bordered">
                        <tbody id="tindak-lanjut-body">
                            @foreach ($rapat->tindakLanjutRapat as $i => $t)
                                <tr>
                                    <td>{{ $i + 1 }}</td>
                                    <td><input type="text" name="tindak_tindakan[]" value="{{ $t->tindakan }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="tindak_pelaksana[]" value="{{ $t->pelaksana }}"
                                            class="form-control"></td>
                                    <td><input type="date" name="tindak_target[]" value="{{ $t->target_selesai }}"
                                            class="form-control"></td>
                                    <td><input type="text" name="tindak_status[]" value="{{ $t->status }}"
                                            class="form-control"></td>
                                    <td><button type="button" class="btn btn-danger btn-sm deleteRow">X</button></td>
                                </tr>
                            @endforeach
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm mb-3" id="addTindak">+ Tambah Tindak
                        Lanjut</button>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="date" name="tanggal_rapat_berikutnya"
                                    value="{{ $rapat->tanggal_rapat_berikutnya }}" class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Agenda</td>
                            <td><input type="text" name="agenda_rapat_berikutnya"
                                    value="{{ $rapat->agenda_rapat_berikutnya }}" class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Nama Kota</td>
                            <td><input type="text" name="nama_kota" value="{{ $rapat->nama_kota }}"
                                    class="form-control"></td>
                        </tr>
                    </table>
                    ...
                    <div class="text-end mt-3">
                        ...
                        <button type="submit" class="btn btn-warning px-3" id="btnSubmitUpdate">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const form = document.getElementById("formRapat");
