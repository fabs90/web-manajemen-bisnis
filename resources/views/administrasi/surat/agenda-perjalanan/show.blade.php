            ...
            <form action="{{ route('administrasi.agenda-perjalanan.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama_pelaksana" class="form-control @error('nama_pelaksana') is-invalid @enderror" value="{{ $agendaPerjalanan->nama_pelaksana }}">
                        @error('nama_pelaksana') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Jabatan</label>
                        <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror" value="{{ old('jabatan', $agendaPerjalanan->jabatan) }}">
                        @error('jabatan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Tujuan</label>
                        <input type="text" name="tujuan" class="form-control @error('tujuan') is-invalid @enderror" value="{{ old('tujuan', $agendaPerjalanan->tujuan) }}">
                        @error('tujuan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-3 mb-3">
                        <label>Tanggal Mulai</label>
                        <input type="date" name="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" value="{{ old('tanggal_mulai', $agendaPerjalanan->tanggal_mulai) }}">
                        @error('tanggal_mulai') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-3 mb-3">
                        <label>Tanggal Selesai</label>
                        <input type="date" name="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" value="{{ old('tanggal_selesai', $agendaPerjalanan->tanggal_selesai) }}">
                        @error('tanggal_selesai') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-12 mb-3">
                        <label>Keperluan</label>
                        <textarea name="keperluan" class="form-control @error('keperluan') is-invalid @enderror" rows="2">{{ old('keperluan', $agendaPerjalanan->keperluan) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('transportasi_pergi', optional($agendaPerjalanan->agendaPerjalananTransportasi->first())->penerbangan_pergi) }}">
                    @error('transportasi_pergi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="mb-3">
                    <label>Penerbangan Pulang</label>
                    <input type="text" name="transportasi_pulang" class="form-control @error('transportasi_pulang') is-invalid @enderror" value="{{ old('transportasi_pulang', optional($agendaPerjalanan->agendaPerjalananTransportasi->first())->penerbangan_pulang) }}">
                    @error('transportasi_pulang') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="mb-3">
                    <label>Kode Booking</label>
                    <input type="text" name="kode_booking" class="form-control @error('kode_booking') is-invalid @enderror" value="{{ old('kode_booking', $agendaPerjalanan->agendaPerjalananTransportasi->first()->kode_booking) }}">
                    @error('kode_booking') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="mb-3">
                    <label>Transportasi Lokal (Rental / Taxi / Lainnya)</label>
                    <input type="text" name="transportasi_lokal" class="form-control @error('transportasi_lokal') is-invalid @enderror" value="{{ old('transportasi_lokal', $agendaPerjalanan->agendaPerjalananTransportasi->first()->transportasi_lokal) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label>Hotel</label>
                        <input type="text" name="akomodasi_hotel" class="form-control" value="{{ old('akomodasi_hotel', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->hotel) }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Alamat</label>
                        <input type="text" name="akomodasi_alamat" class="form-control" value="{{ old('akomodasi_alamat', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->alamat) }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>Nomor Telepon</label>
                        <input type="text" name="akomodasi_telpon" class="form-control" value="{{ old('akomodasi_telpon', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->telepon) }}">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>Check-In</label>
                        <input type="date" name="akomodasi_check_in" class="form-control" value="{{ old('akomodasi_check_in', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->check_in) }}" placeholder="Check-In / Check-Out">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>Check-Out</label>
                        <input type="date" name="akomodasi_check_out" class="form-control" value="{{ old('akomodasi_check_out', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->check_out) }}" placeholder="Check-In / Check-Out">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label>Booking Number</label>
                        <input type="text" name="akomodasi_booking_no" class="form-control" value="{{ old('akomodasi_booking_no', $agendaPerjalanan->agendaPerjalananAkomodasi->first()->booking_number) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-5 mb-3">
                        ...
                        <input type="text"
                               name="kontak[0][nama]"
                               class="form-control"
                               value="{{ old('kontak.0.nama', optional($agendaPerjalanan->agendaPerjalananKontak[0])->nama) }}">

                    </div>
                    <div class="col-md-5 mb-3">
                        <label>Telp</label>
                        <input type="text" name="kontak[0][tel]" class="form-control" value="{{ old('kontak.0.tel', optional($agendaPerjalanan->agendaPerjalananKontak[0])->telepon) }}">
                    </div>

                    <div class="col-md-5 mb-3">
                        <label>Nama 2</label>
                        <input type="text" name="kontak[1][nama]" class="form-control" value="{{ old('kontak.1.nama', optional($agendaPerjalanan->agendaPerjalananKontak[1])->nama) }}">
                    </div>
                    <div class="col-md-5 mb-3">
                        <label>Telp</label>
                        <input type="text" name="kontak[1][tel]" class="form-control" value="{{ old('kontak.1.tel', optional($agendaPerjalanan->agendaPerjalananKontak[1])->telepon) }}">
                    </div>

                    <div class="col-md-5 mb-3">
                        <label>Emergency</label>
                        <input type="text" name="kontak[2][nama]" class="form-control" value="{{ old('kontak.2.nama', optional($agendaPerjalanan->agendaPerjalananKontak[2])->nama) }}">
                    </div>
                    <div class="col-md-5 mb-3">
                        <label>Telp Emergency</label>
                        <input type="text" name="kontak[2][tel]" class="form-control" value="{{ old('kontak.2.tel', optional($agendaPerjalanan->agendaPerjalananKontak[2])->telepon) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01" name="transport" class="form-control @error('transport') is-invalid @enderror" value="{{ old('transport', $agendaPerjalanan->transport) }}">
                        @error('transport') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Akomodasi</label>
                        <input type="number" step="0.01" name="akomodasi" class="form-control @error('akomodasi') is-invalid @enderror" value="{{ old('akomodasi', $agendaPerjalanan->akomodasi) }}">
                        @error('akomodasi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Konsumsi</label>
                        <input type="number" step="0.01" name="konsumsi" class="form-control @error('konsumsi') is-invalid @enderror" value="{{ old('konsumsi', $agendaPerjalanan->konsumsi) }}">
                        @error('konsumsi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Lain-lain</label>
                        <input type="number" step="0.01" name="lain_lain" class="form-control @error('lain_lain') is-invalid @enderror" value="{{ old('lain_lain', $agendaPerjalanan->lain_lain) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="disiapkan_oleh" class="form-control" value="{{ old('disiapkan_oleh',$agendaPerjalanan->disiapkan_oleh) }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Tanggal Disiapkan</label>
                        <input type="date" name="tanggal_disiapkan" class="form-control" value="{{ old('tanggal_disiapkan', $agendaPerjalanan->tanggal_disiapkan) }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Disetujui Oleh</label>
                        <input type="text" name="disetujui_oleh" class="form-control" value="{{ old('disetujui_oleh',$agendaPerjalanan->disetujui_oleh) }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Tanggal Disetujui</label>
                        <input type="date" name="tanggal_disetujui" class="form-control" value="{{ old('tanggal_disetujui', $agendaPerjalanan->tanggal_disetujui) }}">
                    </div>
                </div>
