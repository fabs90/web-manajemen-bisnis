                        ...
                        @foreach ($agenda as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('administrasi.agenda-perjalanan.pdf', ['id' => $item->id]) }}"
                                        class="btn btn-warning btn-sm w-100 text-white mb-1" title="Download SPP">
                                        <i class="bi bi-file-pdf"></i> Download Itineri
                                    </a>
                                    <a href="{{ route('administrasi.agenda-perjalanan.pdf-surat-tugas', ['id' => $item->id]) }}"
                                        class="btn btn-success btn-sm w-100" title="Download Surat Tugas">
