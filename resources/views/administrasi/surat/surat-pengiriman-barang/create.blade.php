...
@section('page-title', 'Input Surat Pengiriman Barang (SPB) ke Pelanggan | TRANSDIGITAL')
            ...
            <div class="card-body py-4">
                <form action="{{ route('administrasi.spb.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Nama Pengirim Barang</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="keadaan" id="keadaan"
                                        ...
                                        <option value="baik" {{ old('keadaan', 'baik') === 'baik' ? 'selected' : '' }}>
                                            Baik</option>
