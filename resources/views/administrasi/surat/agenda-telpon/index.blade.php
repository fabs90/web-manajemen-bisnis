...
@section('page-title', 'Agenda Janji Telpon | TRANSDIGITAL - Pengelolaan Administrasi dan Transaksi Bisnis')
                        ...
                        @foreach ($agendaBelum as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('administrasi.agenda-telpon.update-done', $item->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PATCH')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-3">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th class="bg-primary text-white">Tanggal Panggilan</th>
                                            <td>{{ $item->tgl_panggilan }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Waktu Panggilan</th>
                                            <td>{{ $item->waktu_panggilan }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Nama Penelpon</th>
                                            <td>{{ $item->nama_penelpon }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Perusahaan</th>
                                            <td>{{ $item->perusahaan }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">No Telpon</th>
                                            <td>{{ $item->nomor_telpon }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Jadwal</th>
                                            <td>{{ $item->jadwal_tanggal }} - {{ $item->jadwal_waktu }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Keperluan</th>
                                            <td>{{ $item->keperluan }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg-primary text-white">Tingkat Status</th>
                                        ...
                                        <tr>
                                            <th class="bg-primary text-white">Catatan Khusus</th>
