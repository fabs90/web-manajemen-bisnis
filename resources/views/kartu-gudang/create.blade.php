                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('kartu-gudang.store', ['barang_id' => $barang->id]) }}" method="post">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" id="uraian"
                                            name="uraian" placeholder="Contoh: Stok Masuk dari Supplier A" required
                                            value="{{ old('uraian') }}">
                                    </div>
                                ...
                                <div class="col-12">
                                    <hr class="my-2">
                                    <p class="text-muted small fw-bold text-uppercase mb-3">Detail Pergerakan Barang (Unit)
                                    </p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div
                                        ...
                                        <div class="form-text text-success small mt-2">Gunakan jika ada barang baru yang
                                            masuk.</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div
                                        ...
                                        <div class="form-text text-danger small mt-2">Gunakan jika ada barang yang keluar
                                            gudang.</div>
                                    </div>
                                </div>
                            </div>
