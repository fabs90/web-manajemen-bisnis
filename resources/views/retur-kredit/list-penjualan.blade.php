...
@section('section-heading', 'List Retur Penjualan')
@section('section-row')
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#detailModal{{ $retur->id }}" title="Detail">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                    <a href="{{ route('administrasi.memo-kredit.generatePdf', ['fakturId' => $retur->faktur_penjualan_id]) }}"
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                {{ $retur->fakturPenjualan->suratPengirimanBarang->pesananPenjualan->pelanggan->nama ?? '-' }}<br>
