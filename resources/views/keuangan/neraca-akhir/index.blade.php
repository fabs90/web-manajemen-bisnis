...
@section('page-title', 'Neraca Akhir | TRANSDIGITAL - Pengelolaan Administrasi dan Transaksi Bisnis')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Piutang</td>
                        <td class="text-end">Rp {{ number_format($saldoPiutang, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td>Persediaan Barang Dagang Akhir</td>
                        <td class="text-end">Rp {{ number_format($nilaiPersediaan, 0, ',', '.') }}</td>
                    </tr>
                    ...
                    <tr>
                        <td>Tanah</td>
                        <td class="text-end">Rp {{ number_format($tanah, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td>Kendaraan</td>
                        <td class="text-end">Rp {{ number_format($kendaraan, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td>Peralatan</td>
                        <td class="text-end">Rp {{ number_format($peralatan, 0, ',', '.') }}</td>
                    </tr>
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td>Hutang</td>
                        <td class="text-end">Rp {{ number_format($saldoHutang, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td>Pajak</td>
        ...
        <div class="mt-4 text-center">
            @if ($totalAktiva == $totalPasiva)
                <div class="alert alert-success fw-bold">
                    ✅ Neraca seimbang — Total Aktiva dan Pasiva bernilai sama (Rp
