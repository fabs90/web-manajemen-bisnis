...
@section('page-title', 'Tambah Pendapatan Lain-Lain | TRANSDIGITAL - Pengelolaan Administrasi dan Transaksi Bisnis')
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="{{ route('keuangan.pendapatan.store_lain') }}" method="POST">
            ...
            {{-- Uraian Pendapatan --}}
            <div class="mb-3">
                <label for="uraian_pendapatan" class="form-label">Uraian Penerimaan Kas Perusahaan Lain-Lain<span class="text-danger">*</span></label>
            ...
            {{-- Jumlah (wajib) --}}
            <div class="mb-3">
                <label for="jumlah" class="form-label">Jumlah Penerimaan Kas Perusahaan Lain-Lain <span class="text-danger">*</span></label>
