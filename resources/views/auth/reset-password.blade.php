...
<head>
    ...
    <title>Reset Password | TRANSDIGITAL</title>
...
<body>
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('password.store') }}" onsubmit="showLoading()">
                @csrf
    ...
    <script>
        function showLoading() {
            ...
            document.getElementById('btn-text').innerText = 'Menyimpan...';
