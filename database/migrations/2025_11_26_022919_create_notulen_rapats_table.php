...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('peserta_rapat', function (Blueprint $table) {
            $table->id();
            $table->foreignId('agenda_rapat_id')->constrained('agenda_rapat')->onDelete('cascade');
            $table->string('nama');
        ...
        Schema::create('keputusan_rapat', function (Blueprint $table) {
            $table->id();
            $table->foreignId('agenda_rapat_id')->constrained('agenda_rapat')->onDelete('cascade');
            // $table->foreignId('rapat_detail_id')->constrained('rapat_detail')->onDelete('cascade');
